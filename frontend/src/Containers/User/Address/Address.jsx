...
const Address = () => {
  ...
  const handleSubmit = (event) => {
    ...
    console.log(user_id, "IDDDDDD");
    console.log(userAccessToken, "ACCESS");
    

    const response = axios.post(`/api/user/user-address/${user_id}/`, data_stringify, {
      headers: {
              ...
              <Row>
                ...
                <Col sm={4}>
                  <Form.Group controlId="zip">
                    ...
                    <Form.Control required type="tel" placeholder="ZIP" name="zip" onChange={handleInputChange} />
                  </Form.Group>
                </Col>
              </Row>
              <Row>
